...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "www", "dev","aux", "sh", "misc","game", "song" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "Scroll_Lock",
        function () 
          awful.util.spawn("/home/bemesko/.scripts/scroll_lock_led") 
        end
    ),
    awful.key({modkey, "Shift" }, "n",
        function () 
          awful.util.spawn("exo-open --launch WebBrowser https://www.notion.so/bemesko/In-cio-d31ba6c3ab4146278aa6df28e1c43c34")
        end,
        {description = "open Notion", group = "launcher"}
    ),
    awful.key({modkey, "Shift" }, "y",
        function () 
          awful.util.spawn("exo-open --launch WebBrowser https://www.youtube.com/playlist?list=WL") 
        end,
        {description = "open YouTube", group = "launcher"}
    ),
    awful.key({modkey, "Shift" }, "w",
        function () 
          awful.util.spawn("exo-open --launch WebBrowser web.whatsapp.com") 
        end,
...
awful.rules.rules = {
    ...
    -- Mudar abaixo para true se quiser barra de título nas janelas
